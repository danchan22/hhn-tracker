...
const HHN_MAP_LOCATIONS = [
  ...
  { id: 'stranger-things-lagoon', name: 'Stranger Things Lagoon Show', shortName: 'Lagoon Show', category: 'show', lat: 28.4772141320968, lng: -81.46822099260383, anchorOffset: [-15, -15] },
